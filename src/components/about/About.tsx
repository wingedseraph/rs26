  ...
  return (
    <>
      ...
      >
        ...
        <p className='
          pointer-events-none line-clamp-1 flex-1 font-bold break-all
          text-black-tisa opacity-0 transition-opacity
        '
        >
          Settings
        </p>
      ...
      <div
        ...
        '
      >
        <h1 className='sm:text-9xl/30'>Art enriches the soul, and that is what this project is all about</h1>
